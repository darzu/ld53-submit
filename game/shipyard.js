...
import { validateMesh } from "../render/mesh.js";
...
function mirrorPath(p, planeNorm) {
    ...
    let mirrorMat3 = mat3.set(tempMat3(), 1 - 2 * a ** 2, -2 * a * b, -2 * a * c, -2 * a * b, 1 - 2 * b ** 2, -2 * b * c, -2 * a * c, -2 * b * c, 1 - 2 * c ** 2);
...
function appendBoard(mesh, board) {
