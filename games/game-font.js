...
import { cloneMesh, scaleMesh, stringifyMesh } from "../render/mesh.js";
...
export async function initFontEditor(em) {
    ...
    EM.registerSystem(null, [CameraComputedDef, CanvasDef, CameraDef, InputsDef, UICursorDef], async (_, res) => {
        ...
        cameraComputed.invViewProj = mat4.invert(cameraComputed.viewProj, cameraComputed.invViewProj);
