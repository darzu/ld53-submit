...
export function constructNetTurret(e, startYaw, startPitch, aabbOrInteractionEntity, cameraYawOffset = 0, cameraPitchOffset = -Math.PI / 8, cameraYawFactor = 0, cameraFollowOffset = CAMERA_OFFSETS.thirdPersonOverShoulder, keyboardControls = false, keyboardSpeed = 1, yawRange = Math.PI, helpText = "") {
...
export function registerTurretSystems(em) {
    ...
    em.registerSystem([TurretDef, InRangeDef, AuthorityDef, CameraFollowDef], [InputsDef, LocalPlayerDef, TextDef], (turrets, res) => {
