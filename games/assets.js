...
import { createEmptyMesh, createTimberBuilder, getBoardsFromMesh, unshareProvokingForWood, WoodAssetsDef, } from "../wood.js";
...
const MeshTransforms = {
    ...
    ld51_cannon: mat4.fromRotationTranslationScale(quat.rotateX(quat.IDENTITY, Math.PI * -0.5, quat.create()), [0, 0, 0], [0.8, 0.8, 0.8], mat4.create()),
};
...
const SHIP_OFFSET = V(3.85 - 2.16, -0.33 - 0.13, -8.79 + 4.63);
