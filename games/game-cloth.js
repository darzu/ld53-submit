...
export async function initClothSandbox(em, hosting) {
    const res = await em.whenResources(AssetsDef, GlobalCursor3dDef, RendererDef, CameraDef);
    ...
    em.ensureComponentOn(ship, RotationDef, quat.fromEuler(0, Math.PI * 0.1, 0, quat.create()));
