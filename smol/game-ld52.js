...
export async function initSmol(em, hosting) {
    ...
    em.ensureComponentOn(ground, PositionDef, V(-WORLD_SIZE * 0.5, -1.1, -WORLD_SIZE * 0.5));
    ...
    const gr = em.new();
    em.ensureComponentOn(gr, RenderableConstructDef, grMesh, undefined, undefined, undefined, "grass");
