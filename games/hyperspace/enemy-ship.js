...
export function createEnemyCrew(em, assets, parent, pos) {
    const e = em.new();
...
export function registerEnemyShipSystems(em) {
    em.registerSystem([EnemyShipLocalDef, EnemyShipPropsDef, UVDirDef, UVShipDef, AuthorityDef], [TimeDef, MeDef], (enemyShips, res) => {
