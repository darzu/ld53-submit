...
import { vec2, vec3, mat4, V } from "../../sprig-matrix.js";
...
import { sceneBufPtr, mainDepthTex, surfacesTexturePtr, worldNormsAndFresTexPtr, unlitTexturePtr, positionsTexturePtr, } from "./std-scene.js";
...
// );
onInit((em) => {
    em.registerSystem([RenderableDef, RenderDataOceanDef, RendererWorldFrameDef], [RendererDef], (objs, res) => {
