...
async function createPathEditor() {
    ...
    async function setLineMesh(newLnMesh) {
        ...
        if (!res.outEnt || !res.outMesh) {
            ...
            const hpEnt_ = EM.new();
            EM.ensureComponentOn(hpEnt_, RenderableConstructDef, res.outMesh, true, undefined, undefined, meshPoolPtr, false, reserve);
            ...
            stdPool.updateMeshTriangles(res.outEnt.renderable.meshHandle, res.outMesh);
