...
// import { oceanJfa } from "../../game/ocean.js";
import { vec3, vec4, mat4 } from "../../sprig-matrix.js";
...
import { RenderableDef, RendererDef, RendererWorldFrameDef, } from "../renderer-ecs.js";
import { mainDepthTex, litTexturePtr, meshPoolPtr, normalsTexturePtr, positionsTexturePtr, sceneBufPtr, surfacesTexturePtr, RenderDataStdDef, } from "./std-scene.js";
...
onInit((em) => {
    const renderObjs = [];
    em.registerSystem([RendererWorldFrameDef, RenderableDef, RenderDataStdDef, DeadDef], [], (objs, _) => {
        renderObjs.length = 0;
        for (let o of objs)
            if (o.renderable.enabled && o.renderable.hidden && !DeletedDef.isOn(o))
                renderObjs.push(o);
    }, "stdRenderListDeadHidden");
    em.registerSystem([RendererWorldFrameDef, RenderableDef, RenderDataStdDef], [], (objs, _) => {
        for (let o of objs)
            if (o.renderable.enabled && !DeletedDef.isOn(o))
                renderObjs.push(o);
    }, "stdRenderList");
    em.registerSystem(null, [RendererDef], (_, res) => {
...
function updateStdRenderData(o) {
...
//# sourceMappingURL=std-mesh%20copy.js.map